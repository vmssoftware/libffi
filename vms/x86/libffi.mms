! MMS/EXT/DESCR=libffi.mms/MACRO=("OUTDIR=OUT","CONFIG=DEBUG","POINTER=32")
! x86
! MMS/EXT/DESCR=[.vms.x86]libffi.mms/MACRO=("OUTDIR=OUT","CONFIG=DEBUG_X86_32","POINTER=32","X86_64=1")
! MMS/EXT/DESCR=[.vms.x86]libffi.mms/MACRO=("OUTDIR=OUT","CONFIG=DEBUG_X86_64","POINTER=64","X86_64=1")
...
! debug
CC_QUALIFIERS = $(CC_QUALIFIERS)/DEBUG/NOOPTIMIZE/LIST=$(MMS$TARGET_NAME)
